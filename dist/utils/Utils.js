...
class Utils {
    ...
    static async link(Search, SOptions = __1.DefaultPlayOptions, Queue) {
        ...
        if (SoundCloudLink) {
            let SoundCloudResult = await soundcloud_downloader_1.default.getInfo(Search);
            return new __1.Song({
    ...
    static async playlist(Search, SOptions = __1.DefaultPlaylistOptions, Queue) {
        ...
        if (SoundCloudPlaylistLink) {
            let SoundCloudResultData = await soundcloud_downloader_1.default.getSetInfo(Search).catch(() => { throw __1.DMPErrors.INVALID_PLAYLIST; });
            let SoundCloudResult = {
            ...
            return new __1.Playlist(SoundCloudResult, Queue, SOptions.requestedBy);
        }
