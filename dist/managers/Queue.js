...
class Queue {
    ...
    async play(search, options = __1.DefaultPlayOptions) {
        ...
        if (song.domain === "SoundCloud") {
            try {
                stream = await soundcloud_downloader_1.default.download(song.url);
            }
            catch (error) {
            ...
            stream = (0, discord_ytdl_core_1.default)(song.url, {
        ...
        const resource = this.connection.createAudioStream(stream, {
            metadata: song,
            inputType: song.domain == 'SoundCloud' ? voice_1.StreamType.Arbitrary : voice_1.StreamType.Raw
        });
        setTimeout(_ => {
